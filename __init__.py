...
class VIEW3D_PT_b2g_pipeline_main_panel(bpy.types.Panel):
    bl_label = "B2G Main Panel"
    bl_idname = "VIEW3D_PT_b2g_pipeline_main_panel"
...
def process_mesh_reset(selected_objects, scene):
    for obj in selected_objects:
        ...
        print(f"Mesh reset for '{obj.name}'! - {scene.body_type}")
...
classes = (
    ...
    VIEW3D_PT_b2g_pipeline_main_panel,
)
